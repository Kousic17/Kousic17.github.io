        ...
        return (
            <div className="about">
                ...
                <h1 className="subtopic">About Me</h1>
                     <p>UX/UI designer with less than one year of experience. Had worked on few projects throughout my career. What's crucial for me when starting 
                        one is to get very clear on the goals right at the start and then create a plan with milestones. So, that way in case there are any significant
                        issues, I'll still have a better amount of time to complete before the deadline. I always typically break down larger tasks into smaller chunks,
                        which will be easier for me to know where to start. I also played some important roles in the aspect of software development.
                        <br/>
                        <br/>
