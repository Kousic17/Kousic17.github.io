            ...
            <header className= "main">
                ...
                <nav className="nav-wrap">
                    <ul className="nav" style={{backgroundColor: `${this.state.navBackground}`}}>
                        ...
                        <Link activeClass="active" to="exp" spy={true} smooth={true} duration={1000}>
                            Education
                        </Link>
                ...
                <div className="condiv pic"> 
                    ...
                    <ReactTypingEffect className="typingeffect" text={['Kousic Srinivasan', 'UX/UI designer']} speed={100} eraseDelay={700}/>
                    <Social />
                </div>
                </Fade>
            </header>
